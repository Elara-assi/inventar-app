...
INSERT INTO object_classes (
  ...
  ('Notebook', 'notebook', 'Laptops, Notebooks und mobile Arbeitsrechner', 'it_ausstattung', false, false, true),
  ('Eingabegerät', 'eingabegeraet', 'Computermaus, Tastatur, Trackpad und einfache IT-Peripherie', 'it_ausstattung', false, false, false),
...
JOIN (VALUES
  ...
  ('notebook','object_photo','Objektfoto',true,true,true,'object','human',false,'Erfasser',10),
  ('notebook','condition','Zustand',true,true,false,null,'human_or_ai',true,'Prüfer',20),
  ('notebook','brand','Hersteller',false,false,false,null,'human_or_ai',true,'Prüfer',30),
  ('notebook','serial_number','Seriennummer falls sichtbar',false,false,false,null,'human_or_ai',true,'Prüfer',40),
  ('eingabegeraet','object_photo','Objektfoto',true,true,true,'object','human',false,'Erfasser',10),
  ('eingabegeraet','condition','Zustand',true,true,false,null,'human_or_ai',true,'Prüfer',20),
  ('eingabegeraet','brand','Hersteller falls sichtbar',false,false,false,null,'human_or_ai',true,'Prüfer',30),
